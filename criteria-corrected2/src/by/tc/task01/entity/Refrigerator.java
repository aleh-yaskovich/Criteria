...
public class Refrigerator extends Appliance{
	...
	public String toString() {
		return "Refrigerator [POWER_CONSUMPTION=" + POWER_CONSUMPTION + ", FREEZER_CAPACITY=" + FREEZER_CAPACITY
				+ ", OVERALL_CAPACITY=" + OVERALL_CAPACITY + ", WEIGHT=" + WEIGHT + ", HEIGHT=" + HEIGHT + ", WIDTH="
				+ WIDTH + "]";
	}
